...
export class TeamsController {
    ...
    @ApiResponse({ status: 200, description: 'Returns all teams with members and lead info' })
    findAll() {
    ...
    @ApiResponse({ status: 200, description: 'Returns team details with members and metrics' })
    ...
    addMember(@Param('id') teamId: string, @Body() addMemberDto: AddTeamMemberDto) {
