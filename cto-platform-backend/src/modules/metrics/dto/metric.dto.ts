import { IsString, IsNumber, IsEnum, IsOptional, IsUUID, IsDateString, IsObject } from 'class-validator';
...
export class CreateMetricDto {
    ...
    @ApiPropertyOptional({ example: { sprint: 'Sprint 24', notes: 'Good velocity' } })
    @IsObject()
    @IsOptional()
    metadata?: any;
